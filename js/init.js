...
if ( detectMob() ) {
    ...
    newLine(" ".replace(/ /g,'\xa0'));
    newLine(" ".replace(/ /g,'\xa0'));
    newLine("\xa0Since you can not enjoy my website, and spend one of".replace(/ /g,'\xa0'));
    newLine("\xa0the best times of the day, I will provide some links".replace(/ /g,'\xa0'));
    newLine("\xa0for you to hang out, although I warn you that it is".replace(/ /g,'\xa0'));
    newLine("\xa0not as rewarding as the use of my website, although".replace(/ /g,'\xa0'));
    newLine("\xa0it is not bad either.".replace(/ /g,'\xa0'));
    newLine(" ".replace(/ /g,'\xa0'));
    newLine("\xa0Links:".replace(/ /g,'\xa0'));
